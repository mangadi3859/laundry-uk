...
!(function (n, u) {
    ...
    var r = "pagination",
        s = "__pagination-",
        D =
            (u.fn.pagination && l('plugin conflicted, the name "pagination" has been taken by another jQuery plugin.'),
            (u.fn[r] = function (a) {
                if (void 0 !== a) {
                    var t,
                        c = u(this),
                        ...
                        e = {
                            initialize: function () {
                                ...
                                c.data("pagination") || c.data("pagination", {}),
                                    !1 !== t.callHook("beforeInit") &&
                                        (c.data("pagination").initialized && u(".paginationjs", c).remove(),
                                        (t.disabled = !!J.disabled),
                                        (e = t.model = { pageRange: J.pageRange, pageSize: J.pageSize }),
                            ...
                            render: function (a) {
                                var e = this,
                                    ...
                                    a = !0 !== a,
                                    t = (e.callHook("beforeRender", a), t.pageNumber || J.pageNumber),
                                    i = J.pageRange || 0,
                                    n = e.getTotalPage(),
                                    r = t - i,
                                    s = t + i;
                                return (
                                    (r = n < s ? ((r = (s = n) - 2 * i) < 1 ? 1 : r) : r) <= 1 && ((r = 1), (s = Math.min(2 * i + 1, n))),
                                    o.html(e.generateHTML({ currentPage: t, pageRange: i, rangeStart: r, rangeEnd: s })),
                            ...
                            generatePageNumbersHTML: function (a) {
                                ...
                                if (null === J.pageRange)
                                    for (e = 1; e <= o; e++)
                                        s += e == t ? `<li class="${l}-page J-paginationjs-page ${c} ${u}" data-num="${e}"><a>${e}</a></li>` : `<li class="${l}-page J-paginationjs-page ${c}" data-num="${e}">${i(e)}</li>`;
                                else {
                                    if (n <= 3)
                                        for (e = 1; e < n; e++)
                                            s += e == t ? `<li class="${l}-page J-paginationjs-page ${c} ${u}" data-num="${e}"><a>${e}</a></li>` : `<li class="${l}-page J-paginationjs-page ${c}" data-num="${e}">${i(e)}</li>`;
                                    else J.hideFirstOnEllipsisShow || (s += `<li class="${l}-page ${l}-first J-paginationjs-page ${c}" data-num="1">${i(1)}</li>`), (s += `<li class="${l}-ellipsis ${g}"><a>${a}</a></li>`);
                                    for (e = n; e <= r; e++)
                                        s += e == t ? `<li class="${l}-page J-paginationjs-page ${c} ${u}" data-num="${e}"><a>${e}</a></li>` : `<li class="${l}-page J-paginationjs-page ${c}" data-num="${e}">${i(e)}</li>`;
                                    if (o - 2 <= r) for (e = r + 1; e <= o; e++) s += `<li class="${l}-page J-paginationjs-page ${c}" data-num="${e}">${i(e)}</li>`;
                                    else (s += `<li class="${l}-ellipsis ${g}"><a>${a}</a></li>`), J.hideLastOnEllipsisShow || (s += `<li class="${l}-page ${l}-last J-paginationjs-page ${c}" data-num="${o}">${i(o)}</li>`);
                                }
                                return s;
                            },
                            generateHTML: function (a) {
                                ...
                                if (
                                    (L && (x += e = t.replaceVariables(L, { currentPage: o, totalPage: i, totalNumber: r })),
                                    g &&
                                        C &&
                                        (x += `<div class="${y}-nav J-paginationjs-nav">${(e = t.replaceVariables(C, { currentPage: o, totalPage: i, totalNumber: r, rangeStart: (o - 1) * s + 1, rangeEnd: Math.min(o * s, r) }))}</div>`),
                                    (l || u || c) &&
                                        ((x = x + '<div class="paginationjs-pages">' + ($ ? `<ul class="${$}">` : "<ul>")),
                                        l && (o <= 1 ? O || (x += `<li class="${y}-prev ${N} ${k}"><a>${b}</a></li>`) : (x += `<li class="${y}-prev J-paginationjs-previous ${k}" data-num="${o - 1}" title="Previous page">${n(b)}</li>`)),
                                        u && (x += t.generatePageNumbersHTML(a)),
                                        c && (i <= o ? z || (x += `<li class="${y}-next ${N} ${P}"><a>${h}</a></li>`) : (x += `<li class="${y}-next J-paginationjs-next ${P}" data-num="${o + 1}" title="Next page">${n(h)}</li>`)),
                                        (x += "</ul></div>")),
                                    p && D.isArray(f))
                                ) {
                                    -1 === f.indexOf(s) && (f.unshift(s), f.sort((a, e) => a - e));
                                    for (let a = 0; a < f.length; a++) j += `<option value="${f[a]}"${f[a] === s ? " selected" : ""}>${f[a]} / page</option>`;
                                    (e = j += "</select>"), (x += `<div class="paginationjs-size-changer">${(e = T ? t.replaceVariables(T, { length: j, total: r }) : e)}</div>`);
                                }
                                return (
                                    d && H && (x += `<div class="${y}-go-input">${(e = t.replaceVariables(H, { currentPage: o, totalPage: i, totalNumber: r, input: S }))}</div>`),
                                    m && w && (x += `<div class="${y}-go-button">${(e = t.replaceVariables(w, { currentPage: o, totalPage: i, totalNumber: r, button: v }))}</div>`),
                                    E && (x += e = t.replaceVariables(E, { currentPage: o, totalPage: i, totalNumber: r })),
                                    x
                                );
                            },
                            ...
                            go: function (a, t) {
                                ...
                                function l(a) {
                                    ...
                                    !1 !== r.callHook("beforePaging", n) &&
                                        ((s.direction = void 0 === s.pageNumber ? 0 : n > s.pageNumber ? 1 : -1),
                                        (s.pageNumber = n),
                                        r.render(),
                                        r.disabled && r.isAsync && r.enable(),
                                        (c.data("pagination").model = s),
                                        J.formatResult && ((e = u.extend(!0, [], a)), D.isArray((a = J.formatResult(e))) || (a = e)),
                                        (c.data("pagination").currentPageData = a),
                                        r.doCallback(a, t),
                                        r.callHook("afterPaging", n),
                                        1 == n ? r.callHook("afterIsFirstPage") : n == r.getTotalPage() && r.callHook("afterIsLastPage"));
                                }
                                r.disabled ||
                                    ((n = a), !(n = parseInt(n))) ||
                                    n < 1 ||
                                    ((a = J.pageSize), (o = r.getTotalNumber()), (i = r.getTotalPage()), 0 < o && i < n) ||
                                    (r.isAsync
                                        ? ((i = (o = J.alias || {}).pageSize || "pageSize"),
                                          (o = o.pageNumber || "pageNumber"),
                                          ((e = {})[i] = a),
                                          (e[o] = n),
                                          (i = "function" == typeof J.ajax ? J.ajax() : J.ajax) && i.pageNumberStartWithZero && (e[o] = n - 1),
                                          u.extend(!0, (a = { type: "get", cache: !1, data: {}, contentType: "application/x-www-form-urlencoded; charset=UTF-8", dataType: "json", async: !0 }), i),
                                          u.extend(a.data, e),
                                          (a.url = J.dataSource),
                            ...
                            parseDataSource: function (a, e) {
                                ...
                                D.isObject(a)
                                    ...
                                    : "string" == typeof a
                                    ? (/^https?|file:/.test(a) && (J.ajaxDataType = "jsonp"), e(a))
                            ...
                            callHook: function (a) {
                                ...
                                return (
                                    o.shift(),
                                    J[a] && "function" == typeof J[a] && !1 === J[a].apply(n, o) && (t = !1),
                                    e.hooks &&
                                        e.hooks[a] &&
                                ...
                                var o = this,
                                    ...
                                    a =
                                        ...
                                        t.on("click", ".J-paginationjs-page", function (a) {
                                            ...
                                            if (t && !e.hasClass(J.disableClassName) && !e.hasClass(J.activeClassName))
                                                return !1 !== o.callHook("beforePageOnClick", a, t) && (o.go(t), o.callHook("afterPageOnClick", a, t), !!J.pageLink) && void 0;
                                        }),
                    ...
                    if (c.data("pagination") && !0 === c.data("pagination").initialized) {
                        ...
                        (t = c),
                            u.each(["go", "previous", "next", "disable", "enable", "refresh", "show", "hide", "destroy"], function (a, e) {
                                t.off(s + e);
                            }),
                            t.data("pagination", {}),
                        ...
                        "string" == typeof i.dataSource
                            ? void 0 === i.totalNumberLocator
                                ? void 0 === i.totalNumber
                                    ...
                                    : g(i.totalNumber) || l('"totalNumber" is incorrect. Expect numberic type')
                                : "function" != typeof i.totalNumberLocator && l('"totalNumberLocator" should be a Function.')
                            : D.isObject(i.dataSource) &&
                              (void 0 === i.locator
                                  ? l('"dataSource" is an Object, please specify a "locator".')
                                  : "string" != typeof i.locator && "function" != typeof i.locator && l(i.locator + " is incorrect. Expect string or function type")),
                        void 0 !== i.formatResult && "function" != typeof i.formatResult && l('"formatResult" should be a Function.'),
                        void 0 !== i.onError && "function" != typeof i.onError && l('"onError" should be a Function.'),
                        e.initialize();
                }
                return this;
            }),
